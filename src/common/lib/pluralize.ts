...
export const  pluralize: IPluralize =  (function() {
  ...
  var uncountables :any = {};
  var irregularPlurals:any= {};
  var irregularSingles:any = {};
   ...
   * @return {RegExp}
   */
  function sanitizeRule (rule:string) {
   ...
   */
  function checkWord (replaceMap:any, keepMap:any, rules:any, bool?:any) {
    return function (word:string) {
      var token = word.toLowerCase();
   ...
   */
  pluralize.addPluralRule = function (rule:any, replacement:string) {
   ...
   * @param {string}          replacement
   */
  pluralize.addSingularRule = function (rule:any, replacement:string) {
