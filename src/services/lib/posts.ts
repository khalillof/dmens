...
class Post {
    constructor(title:string, descriptions :string, body:string){
     this.title = title;
...
export const posts : Post[] = [ 
    new Post(
        "Deploying to Kubernetes Using CI/CD",
        "Kubernetes is a popular container orchestration platform that can be used to deploy and manage applications at scale. CI/CD, or Continuous Integration/Continuous Deployment, is a set of practices that automate the build, test, and deployment of software. By combining Kubernetes and CI/CD, you can automate the entire process of building, testing, and deploying your applications, which can save you time and money."
        ,
        `
...
By following the steps in this blog post, you can deploy to Kubernetes using CI/CD. This can save you time and money, and it can help you automate the entire process of building, testing, and deploying your applications.
    ...
    new Post( 
        "Deploy to Kubernetes Using CI/CD in Azure DevOps"
        ,
        `
...
By following the steps in this blog post, you can deploy your applications to Kubernetes quickly and easily.
    ...
    new Post(
       "Deploying to Kubernetes Using CI/CD in Azure DevOps with Docker",
     `
...
new Post(
 ...
 `Kubernetes is an open-source system for automating deployment, scaling, and operations of application containers across clusters of hosts. It provides basic mechanisms for deployment and maintenance of applications.
 <br/>
...
,
new Post(
    "CSS Component Based vs Utility Base First Approach",
"In recent years, there has been a growing debate in the CSS community about the best approach to styling web pages. Some developers prefer to use a utility-based approach, while others prefer to use a component-based approach.",
`
...
new Post(
"Best JavaScript Component Frameworks",
`JavaScript component frameworks are a great way to build user interfaces. They provide a set of reusable components that you can use to create your own custom user interfaces. <br/>
...
new Post(
    "What is a JavaScript Component Framework?",
`
...
new Post(
    "Deploy to MicroK8s Using CI/CD"
    ,
    `
