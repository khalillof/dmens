...
exports.autopopulatePlugin = void 0;
function autopopulatePlugin(schema, options) {
    ...
    const autopopulateHandler = function (filter) {
        ...
        for (let i = 0; i < numPaths; ++i) {
            ...
            const optionsToUse = processOption.call(this, pathsToPopulate[i].autopopulate, pathsToPopulate[i].options);
            if (optionsToUse) {
    ...
    if (testFunction('find')) {
        schema.pre('find', function () { return autopopulateHandler.call(this, null); });
        schema.post('find', function (res) { return autopopulateDiscriminators.call(this, res); });
    }
    if (testFunction('findOne')) {
        schema.pre('findOne', function () { return autopopulateHandler.call(this, null); });
        schema.post('findOne', function (res) { return autopopulateDiscriminators.call(this, res); });
    }
    if (testFunction('findOneAndUpdate')) {
        schema.pre('findOneAndUpdate', function () { return autopopulateHandler.call(this, null); });
    ...
    if (testFunction('findOneAndDelete')) {
        schema.pre('findOneAndDelete', function () { return autopopulateHandler.call(this, null); });
    ...
    if (testFunction('findOneAndReplace')) {
        schema.pre('findOneAndReplace', function () { return autopopulateHandler.call(this, null); });
...
exports.autopopulatePlugin = autopopulatePlugin;
;
