...
class AccountController extends default_controller_js_1.DefaultController {
    constructor() {
        super('account');
    }
    async secure(req, res, next) {
        const data = index_js_2.envs.getSecret(req.query['api']);
    ...
    async signin(req, res, next) {
        // local /jwt
        return await (0, index_js_1.authenticateLocal)(req, res, next);
    }
